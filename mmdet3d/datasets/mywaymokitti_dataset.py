...
class MyWaymoKittiDataset(KittiDataset):
    """My Waymo Dataset.
    ...
    CLASSES = ('Car', 'Cyclist', 'Pedestrian', 'Sign')
    ...
    def __init__(self,
        ...
        self.CLASSES = ('Car', 'Cyclist', 'Pedestrian', 'Sign')
        print("Init MyWaymoKitti Dataset:, data_root:", data_root)
        print("MyWaymoKitti Classes:", self.CLASSES)
        print("MyWaymoKitti input classes:",classes)
